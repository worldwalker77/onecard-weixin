...
import cn.worldwalker.onecard.weixin.common.utils.HttpClientUtil;
import cn.worldwalker.onecard.weixin.constant.Constant;
import cn.worldwalker.onecard.weixin.domain.WeiXinAccess;
...
public class WeiXinRpcImpl implements WeiXinRpc{
	...
	private WeiXinUserInfo getWeixinUserInfo(String access_token,String openid){
		...
		weixinUserInfo.setOpenId(obj.getString("openid"));
